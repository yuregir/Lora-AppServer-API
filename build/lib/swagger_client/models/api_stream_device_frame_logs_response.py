...
class ApiStreamDeviceFrameLogsResponse(object):
    ...
    def __init__(self, downlink_frame=None, uplink_frame=None):  # noqa: E501
        """ApiStreamDeviceFrameLogsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def downlink_frame(self):
        """Gets the downlink_frame of this ApiStreamDeviceFrameLogsResponse.  # noqa: E501

        Contains a downlink frame.  # noqa: E501

        :return: The downlink_frame of this ApiStreamDeviceFrameLogsResponse.  # noqa: E501
    ...
    def downlink_frame(self, downlink_frame):
        """Sets the downlink_frame of this ApiStreamDeviceFrameLogsResponse.

        Contains a downlink frame.  # noqa: E501

        :param downlink_frame: The downlink_frame of this ApiStreamDeviceFrameLogsResponse.  # noqa: E501
    ...
    def uplink_frame(self):
        """Gets the uplink_frame of this ApiStreamDeviceFrameLogsResponse.  # noqa: E501

        Contains an uplink frame.  # noqa: E501

        :return: The uplink_frame of this ApiStreamDeviceFrameLogsResponse.  # noqa: E501
    ...
    def uplink_frame(self, uplink_frame):
        """Sets the uplink_frame of this ApiStreamDeviceFrameLogsResponse.

        Contains an uplink frame.  # noqa: E501

        :param uplink_frame: The uplink_frame of this ApiStreamDeviceFrameLogsResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiStreamDeviceFrameLogsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiStreamDeviceFrameLogsResponse):
            return False
